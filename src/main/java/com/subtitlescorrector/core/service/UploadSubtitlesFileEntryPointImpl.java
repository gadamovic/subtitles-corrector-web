...
//			case CORRECTION:
//				SrtSubtitleFileData correctionData = correctionService.applyCorrectionOperations(params, storedFile);
//				return Util.srtSubtitleFileDataToJson(correctionData);
//			case CONVERSION:
//				VttSubtitleConversionFileData conversionData = conversionService.applyConversionOperations(params.getConversionParameters(), storedFile);
